...
<head>
    ...
    <meta name="keywords" cosntent="AdminLTE2定制版">
...
<div class="wrapper">
            ...
            <div class="box box-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" class="btn bg-olive btn-xs"
                                                    onclick="location.href='${pageContext.request.contextPath}/orders/findOrdersById?id=${orders.id}'">
                                                详情
                                            </button>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAll?page=1&pageSize=${pageinfo.pageSize}"
                                   aria-label="Previous">首页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAll?page=${pageinfo.pageNum-1}&pageSize=${pageinfo.pageSize}">上一页</a>
                            </li>

                            <c:forEach begin="1" end="${pageinfo.pages}" var="pagenum">
                                <li <c:if test="${pagenum==pageinfo.pageNum}">class="active"</c:if> ><a
                                        href="${pageContext.request.contextPath}/orders/findAll?page=${pagenum}&pageSize=${pageinfo.pageSize}">${pagenum}</a>
                                </li>
                            </c:forEach>

                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAll?page=${pageinfo.pageNum+1}&pageSize=${pageinfo.pageSize}">下一页</a>
                            </li>
                            <li> <a href="${pageContext.request.contextPath}/orders/findAll?page=${pageinfo.pages}&pageSize=${pageinfo.pageSize}"
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs"><b>Version</b> 1.0.8
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#changePageSize").change(function () {
            ...
            //向服务器发送请求，改变没页显示条数
            location.href = "${pageContext.request.contextPath}/orders/findAll?page=1&pageSize=" + pageSize;
