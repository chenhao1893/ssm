		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="${pageContext.request.contextPath}/syslog/findAll?page=1&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
							<li><a href="${pageContext.request.contextPath}/syslog/findAll?page=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a></li>

							<c:forEach begin="1" end="${pageInfo.pages}" var="pagenum">
								<li <c:if test="${pagenum==pageInfo.pageNum}">class="active"</c:if> ><a href="${pageContext.request.contextPath}/syslog/findAll?page=${pagenum}&pageSize=${pageInfo.pageSize}">${pagenum}</a></li>
							</c:forEach>

							<li><a href="${pageContext.request.contextPath}/syslog/findAll?page=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}">下一页</a></li>
							<li><a href="${pageContext.request.contextPath}/syslog/findAll?page=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
						</ul>
					</div>
				</div>
				<!-- /.box-footer-->
	...
	<script>
		$(document).ready(function() {
            ...
            $("#changePageSize").change(function () {
                ...
                //向服务器发送请求，改变没页显示条数
                location.href = "${pageContext.request.contextPath}/syslog/findAll?page=1&pageSize=" + pageSize;
